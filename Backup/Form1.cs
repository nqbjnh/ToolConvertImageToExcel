...
namespace SuperGridDemo
{
    public partial class Form1 : Office2007Form
    {
        ...
        private void InitRowTags(GridPanel panel)
        {
            ...
            panel.Rows[7].Tag = typeof(DemoNested);
            panel.Rows[8].Tag = typeof(DemoGridBinding);
            panel.Rows[9].Tag = typeof(DemoMasterDetailClassic);
            panel.Rows[10].Tag = typeof(DemoMasterDetail);
            panel.Rows[11].Tag = typeof(DemoVirtualMode);

            panel.Rows[12].Tag = typeof(DemoBasicFiltering);
            panel.Rows[13].Tag = typeof(DemoExtendedFiltering);

            panel.Rows[14].Tag = typeof(DemoGrouping1);
            panel.Rows[15].Tag = typeof(DemoGroupDetail);
            panel.Rows[16].Tag = typeof(DemoRowDetail);

            panel.Rows[17].Tag = typeof(DemoFileExplorer);
            panel.Rows[18].Tag = typeof(DemoSpreadsheet);
            panel.Rows[19].Tag = typeof(DemoUserEdit);
            panel.Rows[20].Tag = typeof(DemoDragDrop);
        }
        ...
        void SuperGridControl1ColumnGrouped(object sender, GridColumnGroupedEventArgs e)
        {
            ...
            switch (s)
            {
                ...
                case "4":
                    e.GridGroup.Text = "Grouping / User Detail";
                    break;
