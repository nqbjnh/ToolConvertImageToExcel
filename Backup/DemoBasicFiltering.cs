...
namespace SuperGridDemo
{
    ...
    public class MyEmployee : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static MyEmployee GetNewEmployee(bool withNulls)
        {
            int si = withNulls ? 0 : 1;

            string fname = FirstNames[_Rand.Next(si, FirstNames.Length)];
            string lname = LastNames[_Rand.Next(si, LastNames.Length)];
